...
public class TableCreator {
   ...
   public static void tableChecker(){
       String[] tables = new String[5];
           tables[0] = "CREATE TABLE IF NOT EXISTS homeworks.\"Smartwatch\"\n" +
                   "(\n" +
                   ...
                   "    OWNER to postgres;";
       tables[1] = "CREATE TABLE IF NOT EXISTS homeworks.\"Phone\"\n" +
               "(\n" +
               "    id character varying COLLATE pg_catalog.\"default\" NOT NULL,\n" +
               "    model character varying COLLATE pg_catalog.\"default\",\n" +
               "    manufacturer character varying COLLATE pg_catalog.\"default\",\n" +
               ...
               "    OWNER to postgres;";
       tables[2] = "CREATE TABLE IF NOT EXISTS homeworks.\"Notebook\"\n" +
               "(\n" +
               "    id character varying COLLATE pg_catalog.\"default\" NOT NULL,\n" +
               "    model character varying COLLATE pg_catalog.\"default\",\n" +
               "    manufacturer character varying COLLATE pg_catalog.\"default\",\n" +
               ...
               "    OWNER to postgres;";
       tables[3] = "CREATE TABLE IF NOT EXISTS homeworks.\"Invoice\"\n" +
               "(\n" +
               "    id character varying COLLATE pg_catalog.\"default\" NOT NULL,\n" +
               ...
               "    OWNER to postgres;";
       tables[4] = "CREATE TABLE IF NOT EXISTS homeworks.products\n" +
               "(\n" +
               "    id character varying COLLATE pg_catalog.\"default\" NOT NULL,\n" +
